...
{
    public class DecimalN4JSONConverter : JsonConverter<Decimal>
    {
        ...
        public override void Write(Utf8JsonWriter writer, Decimal value, JsonSerializerOptions options)
        {
            ...
            else writer.WriteStringValue(value.ToString("N4", new System.Globalization.CultureInfo("pt-br", false)));
        }
    }
}
